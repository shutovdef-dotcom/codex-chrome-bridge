...
- Clean group lifecycle: bridge-owned groups are watched on create/update and marked unsaved when Chrome exposes that API, then bridge-owned tabs are ungrouped before closing to avoid creating new saved closed `Codex Bridge` tab-group chips.
