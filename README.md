...
- Clean group shutdown: bridge-owned tabs are marked unsaved when Chrome exposes that API, then ungrouped before closing to avoid creating new saved closed `Codex Bridge` tab-group chips.
