...
async function selfTest() {
  ...
  const versionChecks = [
    ...
    { label: 'extension module', item: 'safety gates imports', ok: background.includes("from './safety-gates.js'") },
    ...
    { label: 'extension module', item: 'tab loading imports', ok: background.includes("from './tab-loading.js'") },
