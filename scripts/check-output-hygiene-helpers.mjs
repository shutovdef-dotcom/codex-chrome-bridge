...
async function checkSurface() {
  ...
  check(packageJson.scripts?.['check:output-hygiene-helpers'] === 'node ./scripts/check-output-hygiene-helpers.mjs', 'package.json must expose check:output-hygiene-helpers');
