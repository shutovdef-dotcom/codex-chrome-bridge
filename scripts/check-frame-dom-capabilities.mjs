...
check(packageJson.scripts?.['check:frame-dom-capabilities'] === 'node ./scripts/check-frame-dom-capabilities.mjs', 'package.json must expose check:frame-dom-capabilities');
