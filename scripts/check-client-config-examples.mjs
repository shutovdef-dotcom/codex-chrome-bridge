...
check(packageJson?.scripts?.['check:client-config-examples'] === 'node ./scripts/check-client-config-examples.mjs', 'package.json must expose check:client-config-examples');
