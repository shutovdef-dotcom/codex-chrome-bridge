...
check(packageJson.scripts?.['check:autonomy-cloud-boundaries'] === 'node ./scripts/check-autonomy-cloud-boundaries.mjs', 'package.json must expose check:autonomy-cloud-boundaries');
