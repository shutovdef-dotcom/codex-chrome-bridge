...
check(packageJson.scripts?.['check:element-ref-contract'] === 'node ./scripts/checks/extension/check-element-ref-contract.mjs', 'package.json must expose check:element-ref-contract');
