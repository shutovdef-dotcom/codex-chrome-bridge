...
check(packageJson.scripts?.['check:streamable-http-plan'] === 'node ./scripts/checks/docs/check-streamable-http-plan.mjs', 'package.json must expose check:streamable-http-plan');
