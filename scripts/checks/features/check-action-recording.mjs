...
check(packageJson.scripts?.['check:action-recording'] === 'node ./scripts/checks/features/check-action-recording.mjs', 'package.json must expose check:action-recording');
