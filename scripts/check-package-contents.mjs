...
const REQUIRED_PACKAGE_FILES = Object.freeze([
  ...
  'scripts/check-mcp-prompts.mjs',
  'scripts/check-mcp-resources.mjs',
  'scripts/check-tool-advisor.mjs',
  'scripts/check-tab-group-persistence.mjs',
  'scripts/check-output-contract.mjs',
  'scripts/check-run-tab-ownership.mjs',
  'scripts/check-full-page-read.mjs',
  'scripts/check-cpa-offer-preset.mjs',
  'scripts/check-size-aware-screenshot.mjs',
  'scripts/check-output-hygiene-helpers.mjs',
  'scripts/check-diagnostics.mjs',
  'scripts/check-download-manager.mjs',
  'scripts/check-emulation.mjs',
  'scripts/check-network-export.mjs',
  'scripts/check-ubs-fixes.mjs',
  'scripts/check-roadmap-next-slice.mjs',
  'scripts/check-examples-gallery.mjs',
  'scripts/check-client-docs.mjs',
  'scripts/check-client-config-examples.mjs',
  'scripts/check-alias-package.mjs',
  'scripts/check-act-preview.mjs',
  'scripts/check-act-apply.mjs',
  'scripts/check-lighthouse-plan.mjs',
  'scripts/check-extension-package.mjs',
