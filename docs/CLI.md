...
| `act-apply` | `act-apply` | interaction | 30000 ms | yes | yes | Apply exactly one previously previewed action by id with confirmation, then return before/after evidence and a recommended next read. |
