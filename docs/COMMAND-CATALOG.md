...
| extractPage | read | read | 30000 ms | extract | chrome_bridge_extract | no | tabId, allowExternal, kind, maxItems, maxTextChars | Extract structured tables, form structure, lists, key-value blocks, or artifact-backed CPA offer presets without current form values. |
